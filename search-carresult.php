...
<title>TEECAR | CAR LISTING</title>
<!--Bootstrap -->
...
$sql = "SELECT * FROM tblvehicles WHERE tblvehicles.VehiclesBrand=:brand and tblvehicles.FuelType=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
            ...
            <form action="#" method="get">
              <div class="form-group select">
                <select class="form-control">
                  ...
                  <?php $sql = "SELECT * FROM  tblbrands WHERE BrandName LIKE '".$userID."%'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
